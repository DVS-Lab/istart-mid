...
OUTPUT=${MAINOUTPUT}/L3_task-${task}_${REPLACEME}_cnum-${cnum_pad}_cname-${copename}_onegroup_INTs-${INTS}
if [ -e ${OUTPUT}.gfeat/cope1.feat/cluster_mask_zstat1.nii.gz ]; then
	...
	ITEMPLATE=${maindir}/templates/L3_task-mid_model1_${REPLACEME}_${INTS}.fsf
